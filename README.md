...
4.2. [Добавление дочерних элементов](#добавление-дочерних-элементов)\
4.3. [Кнопка старта](#кнопка-старта)\
4.4. [Линия прогресса воспроизведения](#линия-прогресса-воспроизведения)
5. [Итог](#итог)
...
Создаем обвязку вокруг View, чтобы можно было в одном объекте объеденить объект View и обработку состояния вью модели:
```kotlin
